...
def default_argument_parser():
    ...
    parser.add_argument("--config-file", default="/home/yang/GitHub_JDAI-CV_fast-reid-master/configs/Market1501/bagtricks_R50.yml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--resume",
        action="store_true",
